    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="bilans_biologiques", to="gestiondpi.parametrebiomesure"
            ),
        ),
        migrations.CreateModel(
            name="Patient",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "medicament",
                    models.CharField(default="Default Value", max_length=100),
                ),
                (
                    "ordonnance",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="images",
                        to="gestiondpi.bilanradiologique",
                    ),
                ),
            ],
        ),
