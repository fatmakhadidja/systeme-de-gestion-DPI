# Generated by Django 5.1.3 on 2024-12-28 11:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code', models.ImageField(default='default_qr', unique=True, upload_to='qrcodes/')),
                ('medecin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medcin', to='gestiondpi.medecin')),
