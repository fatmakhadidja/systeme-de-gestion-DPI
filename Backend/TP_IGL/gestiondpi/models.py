...
class DPI(models.Model):
    ...
    patient = models.OneToOneField(
        "Patient", on_delete=models.CASCADE, default=1
    )  # Each patient has one DPI
...
class Consultation(models.Model):
    ...
    ordonnance = models.OneToOneField(
        Ordonnance, related_name="consultation", on_delete=models.CASCADE, null=True
    )  # Linked to Ordonnance
...
class Prescription(models.Model):
    ...
    medicament = models.CharField(
        max_length=100, default="Default Value"
    )  # Medication name
